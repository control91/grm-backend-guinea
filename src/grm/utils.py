...
def get_choices(query_result, empty_choice=True):
    choices = [(i['_id'], i['name']) for i in query_result]
    if empty_choice:
        choices = [('', '')] + choices
    return choices
...
def get_region_choices(grm_db, empty_choice=True):
    query_result = grm_db.get_query_result({"type": 'region'})
    return get_choices(query_result, empty_choice)

def get_prefecture_choices(grm_db, empty_choice=True):
    query_result = grm_db.get_query_result({"type": 'prefecture'})
    return get_choices(query_result, empty_choice)
